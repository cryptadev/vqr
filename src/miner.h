...
public:
    ...
    std::unique_ptr<CBlockTemplate> CreateNewPoSBlock(bool& fPoSCancel, std::shared_ptr<CWallet> pwallet, bool fMineWitnessTx=true);
    std::unique_ptr<CBlockTemplate> CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx, bool fProofOfStake, bool& fPoSCancel, std::shared_ptr<CWallet> pwallet);
