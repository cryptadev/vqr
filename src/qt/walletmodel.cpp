    ...
    cachedNumBlocks(0)
{
    ...
    pollTimer->start(2*MODEL_UPDATE_DELAY);
...
bool WalletModel::setWalletLockedPos(bool locked, const SecureString &passPhrase)
{
    if(locked)
    {
        // Lock
    ...
    {
        // Unlock
        return m_wallet->unlock_pos(passPhrase);
    }
}
